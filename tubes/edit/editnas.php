...
<div class="continer-md d-flex justify-content-center align-items-center mt-5">
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <img src="../img/<?= $editnas['gambar']; ?>" width="120" class="img-preview d-blok" id="img-preview">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" name="halaman" id="halaman" class="form-control" value="<?= $editnas["halaman"]; ?>">
        </div>
        <div>
